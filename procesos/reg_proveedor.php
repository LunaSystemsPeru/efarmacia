...
$c_proveedor->setNombre(addslashes(filter_input(INPUT_POST, 'input_razon_social')));
$c_proveedor->setDireccion(addslashes(filter_input(INPUT_POST, 'input_direccion')));
