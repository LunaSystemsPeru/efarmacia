...
class cl_reporte_inventario
{
    ...
    {
        global $conn;
        $query = "select p.nombre as nproducto, p.principio_activo, ps.pcompra, ps.pventa, ps.cantidad, ps.vcto, ps.lote, l.nombre as nlabotario, p.principio_activo, p2.nombre as npresentacion
