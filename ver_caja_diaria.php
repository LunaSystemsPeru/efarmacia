                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default collapsed">
                            <div class="panel-heading">
                                ...
                                <a href="#" class="btn btn-success"> Enviar Señora</a>
                            </div>
                            <div class="panel-body">
                                <?php
                                if ($existe_caja) {
                                    ...
                                    <div class="col-lg-6">
                                        <div class="panel panel-default collapsed">
                                            <div class="panel-heading">
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade" id="modal_reg_movimiento" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Ingrese detalles de movimiento</h5>
