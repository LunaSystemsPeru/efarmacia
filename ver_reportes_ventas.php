...
$title = "Reportes de Ventas - Farmacia - Luna Systems Peru";
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="panel panel-default collapsed">
                    <div class="panel-heading">
                        <h4 class="panel-title">Establecer Fechas de Busqueda</h4>
                    </div>
                    <form>
                        <div class="panel-body">
                            <div class="form-group">
                                <label>Fecha Inicio</label>
                                <input type="date" class="form-control" id="input-fecha-inicio" value="<?php echo date("Y-m") . "-01" ?>">
                            </div>
                            <div class="form-group">
                                <label>Fecha Final</label>
                                <input type="date" class="form-control" id="input-fecha-final" value="<?php echo date("Y-m-d") ?>">
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="col-md-8">
                <div class="panel panel-default collapsed">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <button class="btn btn-success" onclick="verVentasProductosDetalle()"><i class="fa fa-file-excel-o"></i> Resumen de Ventas con Detalle de Productos</button>
                        </div>
                        <div class="form-group">
                            <button class="btn btn-success" onclick="verProductosVendidos()"><i class="fa fa-file-excel-o"></i> Resumen Productos Vendidos</button>
                        </div>
                        <!--
                        <div class="form-group">
...
<script>
    function verVentasProductosDetalle() {
