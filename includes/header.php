    ...
    <nav role="navigation">
        ...
        <form class="navbar-form-custom" method="post" action="#">
            <div class="form-group">
                <input type="text" class="form-control" name="usuario" readonly="true" value="<?php echo $_SESSION['nombre_comercial'] . " | SUCURSAL: " . $_SESSION['nombre_sucursal'] . " | " . $_SESSION['nombre_usuario']?>">
            </div>
        </form>
